...
export const PillIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M11.354 1.646a.5.5 0 01.646 0l10 10a.5.5 0 010 .708l-10 10a.5.5 0 01-.708-.708L20.293 12 11.146 2.854a.5.5 0 010-.708z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M1.646 11.354a.5.5 0 010-.708l10-10a.5.5 0 01.708 0l10 10a.5.5 0 010 .708l-10 10a.5.5 0 01-.708 0l-10-10a.5.5 0 01.708-.708L12 1.707 2.354 11.354z" transform="rotate(45 12 12)" />
  </svg>
);
...
export const PhotographIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v12a1.5 1.5 0 001.5 1.5zm10.5-11.25h.008v.008h-.008V8.25zm.158 0a.225.225 0 01.225-.225h.008a.225.225 0 01.225.225v.008a.225.225 0 01-.225.225h-.008a.225.225 0 01-.225-.225v-.008z" />
    </svg>
);
